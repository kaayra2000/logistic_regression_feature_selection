...
\usepackage{amssymb}  % \checkmark için
    ...
    Yöntemler arasındaki özellik kesişimi analiz edildiğinde, Filtreleme ve Sarmalayıcı arasında 5, Filtreleme ve Gömülü arasında 5, Sarmalayıcı ve Gömülü arasında 8 ortak özellik bulunmaktadır. Tablo~\ref{tab:common_features}'da ortak bulunan özellikler gösterilmiştir.

    \begin{table}[H]
    \caption{Yöntemler Arasında Ortak Özellikler}
    ...
    \textbf{Sarmalayıcı} & \textbf{15} & \textbf{0.6510} & \textbf{0.6502} & \textbf{0.035} \\
    ...
    \begin{itemize}
        ...
        \item Filtreleme: Fark = -0.0000 (Aşırı öğrenme tespit edilmedi)
